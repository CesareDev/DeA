...
void HalfDemon::Init(const ResourceManager& resourceManager, const sf::Vector2f& position)
{
	setTexture(resourceManager.GetTilesetTexture());
	setTextureRect({ 256, 352, 16, 24 });
...
void HalfDemon::SetPosition(const sf::Vector2f& position)
{
	setPosition(position);
...
EntityID HalfDemon::GetId() const
{
    return EntityID::HalfDemon;
}
