...
{
	setPosition(position);
	m_Center  = { position.x + 18.f * cosf(m_Angle * acos(-1.f) / 180.f), position.y + 18.f * sinf(m_Angle * acos(-1.f) / 180.f) };
	m_HitPoints[0] = m_Center;
	m_HitPoints[1] = m_Center + sf::Vector2f(9.f * cosf(m_Angle * acos(-1.f) / 180.f), 9.f * sinf(m_Angle * acos(-1.f) / 180.f));
